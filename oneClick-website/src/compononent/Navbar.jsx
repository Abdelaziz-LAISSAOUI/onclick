...
function Navbar({ toggole, setToggole }) {
  ...
  return (
    <nav className="flex  p-3 bg-[#081A1E] justify-between items-center sticky top-0 z-50">
      <Link to={'/hero'} ><img src={logo} className="w-20" alt="One CLick logo" /></Link> 
      ...
      {toggole &&
        <div className="absolute top-[100%] right-3 bg-[#328773] text-center py-4 px-6 text-white font-medium rounded-br-2xl rounded-bl-2xl">
          <ul className="mb-4">
