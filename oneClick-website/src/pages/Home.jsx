...
import images from "../compononent/images"
...
import image8 from "../assets/services/digitalMarketing.jpeg"
  ...
  return (
    <>
      <section className="p-3 h-screen">
        ...
        <h1 className="text-center text-base mt-10">
          DIVE INTO THE DEPTHS OF <span>DIGITAL</span> BUSINESS
        </h1>
      ...
      <section className="p-3 h-screen relative overflow-hidden bg-slate-500">
        <h2 className="text-center mt-10">
          ABOUT <span>ONE CLICK</span>
        </h2>
      ...
      <section className="p-3 h-screen relative  bg-slate-300">
        <h2 className="text-center m-10">OUR SERVICES</h2>
        <motion.div ref={carouselRef} className="overflow-hidden  cursor-grab ">
          <motion.div drag='x' dragConstraints={{ right: 0, left: -width }} className="flex relative">
            <motion.div className="min-h-[390px] min-w-[336px]  -ml-8" >
            ...
            <motion.div className="min-h-[360px] min-w-[300px]  -ml-8" >
              <Service image={image6} service={'Voice Acting'} />
            </motion.div>
            <motion.div className="min-h-[390px] min-w-[336px]  -ml-8" >
              <Service image={image7} service={'Socail Media'} />
            </motion.div>
            <motion.div className="min-h-[384px] min-w-[324px]  -ml-8" >
              <Service image={image8} service={'Digital Marketing'} />
            </motion.div>
          </motion.div>
        </motion.div>
      </section>
      <section className="p-3 h-screen relative overflow-hidden bg-slate-600">
        <h2 className="text-white text-center m-10">ARE YOU READY TO GROW YOUR BUSINESS</h2>
        <p className="text-white text-center">LET'S KEEP IN TOUCH</p>
